...
class Config:
    ...
    SECRET_KEY = os.environ.get("FLASK_SECRET_KEY", "super-secret-session-key-change-in-prod")
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get("DATABASE_URL", "postgresql://maskd_user:maskd_pass@db:5432/maskd_keys")
